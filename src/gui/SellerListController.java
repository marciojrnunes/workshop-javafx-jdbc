...
public class SellerListController implements Initializable, DataChangeListener {
	...
	// Cria referencia para as telas do SellerList
	@FXML
	...
	public void onBtNewAction(ActionEvent event) {
		...
		Seller obj = new Seller(); // Formulario comeca vazio
	...
	public void updateTableView() {
		...
		initEditButtons(); // Acrescenta um botão com texto Edit emc ada linha
		initRemoveButtons(); 
	}
...
//		}
	...
	@Override
	public void onDataChanged() { // Quando mudar os dados, atualiza tabela
		updateTableView();
